{
  ...
  h_2_f0->SetMarkerStyle(20);
  h_2_f0->SetLineColor(kBlack);
  h_2_f0->SetLineWidth(3);
  h_2_f0->Draw("sames");
  
  l1->AddEntry(h_2_f0,"kWeird","p");
  l1->AddEntry(h_3_f0,"APD hit > 50 ADC","p");
  l1->AddEntry(h_4_f0,"APD hit > 100 ADC","p");
