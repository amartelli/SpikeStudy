...
public :
   ...
   TH2F *h_rechits_Goodvertices_et, *h_rechits_Goodvertices_et_good, *h_rechits_Goodvertices_e_good;
...
void tree::Init(TChain *tree)
{
   ...
   fChain->SetBranchAddress("Rechit_ifkGood", &Rechit_ifkGood, &b_Rechit_ifkGood);
