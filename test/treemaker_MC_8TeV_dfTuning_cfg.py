...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string(
    "file:/afs/cern.ch/work/a/amartell/Upgrade/SpikesStudies/CMSSW_6_1_2_SLHC4/src/DPGTask/SpikeStudy/test/MinBias_PU_8TeV_defTuning.root"
    ),
#                                   fileName = cms.string("MinBias_612_8TeV_arabella_check.root"),
